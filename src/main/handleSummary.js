...
export function handleSummary(data) {
    ...
    return {
        ...
        '/Users/sandra.john/Documents/K6/junit.xml': jUnit(data), // but also transform it and save it as a JUnit XML...
        '/Users/sandra.john/Documents/K6/summary.json': JSON.stringify(data), // and a JSON with all the details...
